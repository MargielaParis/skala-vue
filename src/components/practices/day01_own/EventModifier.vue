<script setup>
const handleLink = () => {
  window.alert('수식어 덕분에 네이버로 이동하지 않고 함수만 실행됩니다!')
}
...
<template>
  <div class="practice-section">
    ...
    <div class="event-box" @click="handleBox">
      ...
      <button @click="showChildAlert('1번 자식 클릭!')">버블링 발생 버튼</button>
      <button @click.stop="showChildAlert('2번 자식(나만 켜짐) 클릭!')">버블링 차단 버튼</button>
    </div>
  </div>
</template>
